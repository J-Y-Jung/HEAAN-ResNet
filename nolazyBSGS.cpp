...
int main() {
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block0conv0_out[i / 5][i % 5], ctxt_block0relu0_out[i / 5][i % 5]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block0conv0_out[8+(i /5)][(i%5)], ctxt_block0relu0_out[8+(i /5)][(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block0conv0_out[i / 5][5+(i%5)], ctxt_block0relu0_out[i / 5][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block0conv0_out[8+(i /5)][5+(i%5)], ctxt_block0relu0_out[8+(i /5)][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block0conv0_out[i / 5][10+(i%5)], ctxt_block0relu0_out[i / 5][10+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block0conv0_out[8+(i /5)][10+(i%5)], ctxt_block0relu0_out[8+(i /5)][10+(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 16; ++i) {
        ReLUnotlazy(context, eval, ctxt_block0conv0_out[i][15], ctxt_block0relu0_out[i][15]);
    }
   ...
   // RB 1 - 1
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 80; ++i) {
        ReLUnotlazy(context, eval, ctxt_block1conv0_out[i / 16][i % 16], ctxt_block1relu0_out[i / 16][i % 16]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 80; ++i) {
        ReLUnotlazy(context, eval, ctxt_block1conv0_out[5 + (i / 16)][i % 16], ctxt_block1relu0_out[5 + (i / 16)][i % 16]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 80; ++i) {
        ReLUnotlazy(context, eval, ctxt_block1conv0_out[10 + (i / 16)][i % 16], ctxt_block1relu0_out[10 + (i / 16)][i % 16]);
    }
    ...
    for (int i = 0; i < 16; ++i) {
        #pragma omp parallel num_threads(5)
        {
            ReLUnotlazy(context, eval, ctxt_block1conv0_out[15][i % 16], ctxt_block1relu0_out[15][i % 16]);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block1add_out[i / 5][i % 5], ctxt_block1relu1_out[i / 5][i % 5]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block1add_out[8+(i /5)][(i%5)], ctxt_block1relu1_out[8+(i /5)][(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block1add_out[i / 5][5+(i%5)], ctxt_block1relu1_out[i / 5][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block1add_out[8+(i /5)][5+(i%5)], ctxt_block1relu1_out[8+(i /5)][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block1add_out[i / 5][10+(i%5)], ctxt_block1relu1_out[i / 5][10+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block1add_out[8+(i /5)][10+(i%5)], ctxt_block1relu1_out[8+(i /5)][10+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 16; ++i) {
        ReLUnotlazy(context, eval, ctxt_block1add_out[i][15], ctxt_block1relu1_out[i][15]);
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2conv0_out[i / 5][i % 5], ctxt_block2relu0_out[i / 5][i % 5]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2conv0_out[8+(i /5)][(i%5)], ctxt_block2relu0_out[8+(i /5)][(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2conv0_out[i / 5][5+(i%5)], ctxt_block2relu0_out[i / 5][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2conv0_out[8+(i /5)][5+(i%5)], ctxt_block2relu0_out[8+(i /5)][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2conv0_out[i / 5][10+(i%5)], ctxt_block2relu0_out[i / 5][10+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2conv0_out[8+(i /5)][10+(i%5)], ctxt_block2relu0_out[8+(i /5)][10+(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 16; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2conv0_out[i][15], ctxt_block2relu0_out[i][15]);
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2add_out[i / 5][i % 5], ctxt_block2relu1_out[i / 5][i % 5]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2add_out[8+(i /5)][(i%5)], ctxt_block2relu1_out[8+(i /5)][(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2add_out[i / 5][5+(i%5)], ctxt_block2relu1_out[i / 5][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2add_out[8+(i /5)][5+(i%5)], ctxt_block2relu1_out[8+(i /5)][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2add_out[i / 5][10+(i%5)], ctxt_block2relu1_out[i / 5][10+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2add_out[8+(i /5)][10+(i%5)], ctxt_block2relu1_out[8+(i /5)][10+(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 16; ++i) {
        ReLUnotlazy(context, eval, ctxt_block2add_out[i][15], ctxt_block2relu1_out[i][15]);
    }
   ...
   // RB 3 - 1
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3conv0_out[i / 5][i % 5], ctxt_block3relu0_out[i / 5][i % 5]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3conv0_out[8+(i /5)][(i%5)], ctxt_block3relu0_out[8+(i /5)][(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3conv0_out[i / 5][5+(i%5)], ctxt_block3relu0_out[i / 5][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3conv0_out[8+(i /5)][5+(i%5)], ctxt_block3relu0_out[8+(i /5)][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3conv0_out[i / 5][10+(i%5)], ctxt_block3relu0_out[i / 5][10+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3conv0_out[8+(i /5)][10+(i%5)], ctxt_block3relu0_out[8+(i /5)][10+(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 16; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3conv0_out[i][15], ctxt_block3relu0_out[i][15]);
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3add_out[i / 5][i % 5], ctxt_block3relu1_out[i / 5][i % 5]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3add_out[8+(i /5)][(i%5)], ctxt_block3relu1_out[8+(i /5)][(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3add_out[i / 5][5+(i%5)], ctxt_block3relu1_out[i / 5][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3add_out[8+(i /5)][5+(i%5)], ctxt_block3relu1_out[8+(i /5)][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3add_out[i / 5][10+(i%5)], ctxt_block3relu1_out[i / 5][10+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3add_out[8+(i /5)][10+(i%5)], ctxt_block3relu1_out[8+(i /5)][10+(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 16; ++i) {
        ReLUnotlazy(context, eval, ctxt_block3add_out[i][15], ctxt_block3relu1_out[i][15]);
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block4MPP0_out[i / 10][i % 10], ctxt_block4relu0_out[i / 10][i % 10]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block4MPP0_out[i / 10][10+(i % 10)], ctxt_block4relu0_out[i / 10][10+(i % 10)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block4MPP0_out[i / 10][20+(i % 10)], ctxt_block4relu0_out[i / 10][20+(i % 10)]);
    }
    ...
    for (int i = 0; i < 8; ++i) {
        #pragma omp parallel num_threads(5)
        {
            ReLUnotlazy(context, eval, ctxt_block4MPP0_out[i / 2][30+(i %2)], ctxt_block4relu0_out[i / 2][30+ (i% 2)]);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block4add_out[i / 10][i % 10], ctxt_block4relu1_out[i / 10][i % 10]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block4add_out[i / 10][10+(i % 10)], ctxt_block4relu1_out[i / 10][10+(i % 10)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block4add_out[i / 10][20+(i % 10)], ctxt_block4relu1_out[i / 10][20+(i % 10)]);
    }
    ...
    for (int i = 0; i < 8; ++i) {
        #pragma omp parallel num_threads(5)
        {
            ReLUnotlazy(context, eval, ctxt_block4add_out[i / 2][30+(i %2)], ctxt_block4relu1_out[i / 2][30+ (i% 2)]);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block5conv0_out[i / 10][i % 10], ctxt_block5relu0_out[i / 10][i % 10]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block5conv0_out[i / 10][10+(i % 10)], ctxt_block5relu0_out[i / 10][10+(i % 10)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block5conv0_out[i / 10][20+(i % 10)], ctxt_block5relu0_out[i / 10][20+(i % 10)]);
    }
    ...
    for (int i = 0; i < 8; ++i) {
        #pragma omp parallel num_threads(5)
        {
            ReLUnotlazy(context, eval, ctxt_block5conv0_out[i / 2][30+(i %2)], ctxt_block5relu0_out[i / 2][30+ (i% 2)]);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block5add_out[i / 10][i % 10], ctxt_block5relu1_out[i / 10][i % 10]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block5add_out[i / 10][10+(i % 10)], ctxt_block5relu1_out[i / 10][10+(i % 10)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block5add_out[i / 10][20+(i % 10)], ctxt_block5relu1_out[i / 10][20+(i % 10)]);
    }
    ...
    for (int i = 0; i < 8; ++i) {
        #pragma omp parallel num_threads(5)
        {
            ReLUnotlazy(context, eval, ctxt_block5add_out[i / 2][30+(i %2)], ctxt_block5relu1_out[i / 2][30+ (i% 2)]);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block6conv0_out[i / 10][i % 10], ctxt_block6relu0_out[i / 10][i % 10]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block6conv0_out[i / 10][10+(i % 10)], ctxt_block6relu0_out[i / 10][10+(i % 10)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block6conv0_out[i / 10][20+(i % 10)], ctxt_block6relu0_out[i / 10][20+(i % 10)]);
    }
    ...
    for (int i = 0; i < 8; ++i) {
        #pragma omp parallel num_threads(5)
        {
            ReLUnotlazy(context, eval, ctxt_block6conv0_out[i / 2][30+(i %2)], ctxt_block6relu0_out[i / 2][30+ (i% 2)]);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block6add_out[i / 10][i % 10], ctxt_block6relu1_out[i / 10][i % 10]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block6add_out[i / 10][10+(i % 10)], ctxt_block6relu1_out[i / 10][10+(i % 10)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block6add_out[i / 10][20+(i % 10)], ctxt_block6relu1_out[i / 10][20+(i % 10)]);
    }
    ...
    for (int i = 0; i < 8; ++i) {
        #pragma omp parallel num_threads(5)
        {
            ReLUnotlazy(context, eval, ctxt_block6add_out[i / 2][30+(i %2)], ctxt_block6relu1_out[i / 2][30+ (i% 2)]);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block7MPP0_out[0][i], ctxt_block7relu0_out[0][i]);
    }
 ...
 // Second convolution
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block7add_out[0][i], ctxt_block7relu1_out[0][i]);
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block8conv0_out[0][i], ctxt_block8relu0_out[0][i]);
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block8add_out[0][i], ctxt_block8relu1_out[0][i]);
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block9conv0_out[0][i], ctxt_block9relu0_out[0][i]);
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ReLUnotlazy(context, eval, ctxt_block9add_out[0][i], ctxt_block9relu1_out[0][i]);
    }
