...
int main() {
    ...
    string temppath = string("/app/block3/");

    loadMsg(enc, sk, ctxt_block3relu1_out, temppath);
    ...
    cout << "input level = " << ctxt_block3relu1_out[0][0].getLevel() << "\n";
    cout << "convolution ...\n";
    ...
    cout << "mpp in level = " << ctxt_block4MPP1_in[0][0][0].getLevel() << "\n";
    ...
    cout << "mpp out level = " << ctxt_block4MPP1_out[0][0].getLevel() << "\n";
    ...
    cout <<"convolution ...\n\n";
    cout << "before block4conv0 level = " <<ctxt_block3relu1_out[0][0].getLevel()<<"\n";
    ...
    cout << "mpp in level = " << ctxt_block4MPP0_in[0][0][0].getLevel() << "\n";
    ...
    cout << "after block4relu0 level = " << ctxt_block4relu0_out[0][0].getLevel() << "\n";
    ...
    cout << "before block4conv1 level = " << ctxt_block4relu0_out[0][0].getLevel() << "\n";
    ...
    cout << "after conv level = " << ctxt_block4conv1_out[0][0].getLevel() << "\n";

    addBNsummands(context, eval, ctxt_block4conv1_out, block4conv1summands32, 4, 32);
    
    cout << "after sum = " << ctxt_block4conv1_out[0][0].getLevel() << "\n";
    ...
    cout << "after level = " << ctxt_block4add_out[0][0].getLevel() << "\n";
    ...
    cout << "after level = " << ctxt_block4relu1_out[0][0].getLevel() << "\n";
