...
int main() {
    ...
    for (int i = 0; i < 16; ++i) { 
        //#pragma omp parallel num_threads(5)
        {
            ctxt_block0conv0_out[i] = Convp(context, pack, eval, 32, 1, 1, 3, 16, imageVec[i], block0conv0multiplicands16_3_3_3);
        }
    }
   ...
   // RB 1 - 1
    ...
    for (int i = 0; i < 16; ++i) {
        //#pragma omp parallel num_threads(5)
        {
            ctxt_block1conv0_out[i] = Convp(context, pack, eval, 32, 1, 1, 16, 16, ctxt_block0relu0_out[i], block1conv0multiplicands16_16_3_3);
        }
    }
    ...
    for (int i = 0; i < 16; ++i) {
        //#pragma omp parallel num_threads(5)
        {
        ctxt_block1conv1_out[i] = Convp(context, pack, eval, 32, 1, 1, 16, 16, ctxt_block1relu0_out[i], block1conv1multiplicands16_16_3_3);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block1add_out[i / 5][i % 5], ctxt_block1relu1_out[i / 5][i % 5]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block1add_out[8+(i /5)][(i%5)], ctxt_block1relu1_out[8+(i /5)][(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block1add_out[i / 5][5+(i%5)], ctxt_block1relu1_out[i / 5][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block1add_out[8+(i /5)][5+(i%5)], ctxt_block1relu1_out[8+(i /5)][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block1add_out[i / 5][10+(i%5)], ctxt_block1relu1_out[i / 5][10+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block1add_out[8+(i /5)][10+(i%5)], ctxt_block1relu1_out[8+(i /5)][10+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 16; ++i) {
        ApproxReLU(context, eval, ctxt_block1add_out[i][15], ctxt_block1relu1_out[i][15]);
    }
    ...
    for (int i = 0; i < 16; ++i) {
        //#pragma omp parallel num_threads(5)
        {
        ctxt_block2conv0_out[i] = Convp(context, pack, eval, 32, 1, 1, 16, 16, ctxt_block1relu1_out[i], block2conv0multiplicands16_16_3_3);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block2conv0_out[i / 5][i % 5], ctxt_block2relu0_out[i / 5][i % 5]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block2conv0_out[8+(i /5)][(i%5)], ctxt_block2relu0_out[8+(i /5)][(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block2conv0_out[i / 5][5+(i%5)], ctxt_block2relu0_out[i / 5][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block2conv0_out[8+(i /5)][5+(i%5)], ctxt_block2relu0_out[8+(i /5)][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block2conv0_out[i / 5][10+(i%5)], ctxt_block2relu0_out[i / 5][10+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block2conv0_out[8+(i /5)][10+(i%5)], ctxt_block2relu0_out[8+(i /5)][10+(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 16; ++i) {
        ApproxReLU(context, eval, ctxt_block2conv0_out[i][15], ctxt_block2relu0_out[i][15]);
    }
    ...
    for (int i = 0; i < 16; ++i) {
        //#pragma omp parallel num_threads(5)
        {
        ctxt_block2conv1_out[i] = Convp(context, pack, eval, 32, 1, 1, 16, 16, ctxt_block2relu0_out[i], block2conv1multiplicands16_16_3_3);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block2add_out[i / 5][i % 5], ctxt_block2relu1_out[i / 5][i % 5]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block2add_out[8+(i /5)][(i%5)], ctxt_block2relu1_out[8+(i /5)][(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block2add_out[i / 5][5+(i%5)], ctxt_block2relu1_out[i / 5][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block2add_out[8+(i /5)][5+(i%5)], ctxt_block2relu1_out[8+(i /5)][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block2add_out[i / 5][10+(i%5)], ctxt_block2relu1_out[i / 5][10+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block2add_out[8+(i /5)][10+(i%5)], ctxt_block2relu1_out[8+(i /5)][10+(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 16; ++i) {
        ApproxReLU(context, eval, ctxt_block2add_out[i][15], ctxt_block2relu1_out[i][15]);
    }
   ...
   // RB 3 - 1
    ...
    for (int i = 0; i < 16; ++i) { // 서로 다른 img
        //#pragma omp parallel num_threads(5)
        {
        ctxt_block3conv0_out[i] = Convp(context, pack, eval, 32, 1, 1, 16, 16, ctxt_block2relu1_out[i], block3conv0multiplicands16_16_3_3);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block3conv0_out[i / 5][i % 5], ctxt_block3relu0_out[i / 5][i % 5]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block3conv0_out[8+(i /5)][(i%5)], ctxt_block3relu0_out[8+(i /5)][(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block3conv0_out[i / 5][5+(i%5)], ctxt_block3relu0_out[i / 5][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block3conv0_out[8+(i /5)][5+(i%5)], ctxt_block3relu0_out[8+(i /5)][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block3conv0_out[i / 5][10+(i%5)], ctxt_block3relu0_out[i / 5][10+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block3conv0_out[8+(i /5)][10+(i%5)], ctxt_block3relu0_out[8+(i /5)][10+(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 16; ++i) {
        ApproxReLU(context, eval, ctxt_block3conv0_out[i][15], ctxt_block3relu0_out[i][15]);
    }
    ...
    for (int i = 0; i < 16; ++i) {
        //#pragma omp parallel num_threads(5)
        {
        ctxt_block3conv1_out[i] = Convp(context, pack, eval, 32, 1, 1, 16, 16, ctxt_block3relu0_out[i], block3conv1multiplicands16_16_3_3);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block3add_out[i / 5][i % 5], ctxt_block3relu1_out[i / 5][i % 5]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block3add_out[8+(i /5)][(i%5)], ctxt_block3relu1_out[8+(i /5)][(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block3add_out[i / 5][5+(i%5)], ctxt_block3relu1_out[i / 5][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block3add_out[8+(i /5)][5+(i%5)], ctxt_block3relu1_out[8+(i /5)][5+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block3add_out[i / 5][10+(i%5)], ctxt_block3relu1_out[i / 5][10+(i%5)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block3add_out[8+(i /5)][10+(i%5)], ctxt_block3relu1_out[8+(i /5)][10+(i%5)]);
    }


    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 16; ++i) {
        ApproxReLU(context, eval, ctxt_block3add_out[i][15], ctxt_block3relu1_out[i][15]);
    }
    ...
    for (int i = 0; i < 16; ++i) { // 서로 다른 img
        //#pragma omp parallel num_threads(5)
        {
            ctxt_block4conv_onebyone_out[i] = Convp(context, pack, eval, 32, 1, 2, 16, 32, ctxt_block3relu1_out[i], block4conv_onebyone_multiplicands32_16_1_1);
        }
    }
    ...
    for (int i = 0; i < 16; ++i) { // 서로 다른 img
        //#pragma omp parallel num_threads(5)
        {
            ctxt_block4conv0_out[i] = Convp(context, pack, eval, 32, 1, 2, 16, 32, ctxt_block3relu1_out[i], block4conv0multiplicands32_16_3_3);
        }
    }
    ...
    for (int i = 0; i < 4; ++i) {
        ...
        {
            ctxt_block4conv1_out[i] = Convp(context, pack, eval, 32, 2, 1, 32, 32, ctxt_block4relu0_out[i], block4conv1multiplicands32_32_3_3);
        }
    }
    ...
    for (int i = 0; i < 4; ++i) { // 서로 다른 img
        ...
        #pragma omp parallel num_threads(10)
        {
            ctxt_block5conv0_out[i] = Convp(context, pack, eval, 32, 2, 1, 32, 32, ctxt_block4relu1_out[i], block5conv0multiplicands32_32_3_3);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block5conv0_out[i / 10][10+(i % 10)], ctxt_block5relu0_out[i / 10][10+(i % 10)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block5conv0_out[i / 10][20+(i % 10)], ctxt_block5relu0_out[i / 10][20+(i % 10)]);
    }
    ...
    for (int i = 0; i < 8; ++i) {
        #pragma omp parallel num_threads(5)
        {
            ApproxReLU(context, eval, ctxt_block5conv0_out[i / 2][30+(i %2)], ctxt_block5relu0_out[i / 2][30+ (i% 2)]);
        }
    }
    ...
    for (int i = 0; i < 4; ++i) {
        #pragma omp parallel num_threads(10)
        {
            ctxt_block5conv1_out[i] = Convp(context, pack, eval, 32, 2, 1, 32, 32, ctxt_block5relu0_out[i], block5conv1multiplicands32_32_3_3);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block5add_out[i / 10][10+(i % 10)], ctxt_block5relu1_out[i / 10][10+(i % 10)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block5add_out[i / 10][20+(i % 10)], ctxt_block5relu1_out[i / 10][20+(i % 10)]);
    }
    ...
    for (int i = 0; i < 8; ++i) {
        #pragma omp parallel num_threads(5)
        {
            ApproxReLU(context, eval, ctxt_block5add_out[i / 2][30+(i %2)], ctxt_block5relu1_out[i / 2][30+ (i% 2)]);
        }
    }
    ...
    for (int i = 0; i < 4; ++i) { // 서로 다른 img
        ...
        #pragma omp parallel num_threads(10)
        {
            ctxt_block6conv0_out[i] = Convp(context, pack, eval, 32, 2, 1, 32, 32, ctxt_block5relu1_out[i], block6conv0multiplicands32_32_3_3);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block6conv0_out[i / 10][10+(i % 10)], ctxt_block6relu0_out[i / 10][10+(i % 10)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block6conv0_out[i / 10][20+(i % 10)], ctxt_block6relu0_out[i / 10][20+(i % 10)]);
    }
    ...
    for (int i = 0; i < 8; ++i) {
        #pragma omp parallel num_threads(5)
        {
            ApproxReLU(context, eval, ctxt_block6conv0_out[i / 2][30+(i %2)], ctxt_block6relu0_out[i / 2][30+ (i% 2)]);
        }
    }
    ...
    for (int i = 0; i < 4; ++i) {
        #pragma omp parallel num_threads(10)
        {
            ctxt_block6conv1_out[i] = Convp(context, pack, eval, 32, 2, 1, 32, 32, ctxt_block6relu0_out[i], block6conv1multiplicands32_32_3_3);
        }
    }
    ...
    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block6add_out[i / 10][10+(i % 10)], ctxt_block6relu1_out[i / 10][10+(i % 10)]);
    }

    #pragma omp parallel for num_threads(40)
    for (int i = 0; i < 40; ++i) {
        ApproxReLU(context, eval, ctxt_block6add_out[i / 10][20+(i % 10)], ctxt_block6relu1_out[i / 10][20+(i % 10)]);
    }
    ...
    for (int i = 0; i < 8; ++i) {
        #pragma omp parallel num_threads(5)
        {
            ApproxReLU(context, eval, ctxt_block6add_out[i / 2][30+(i %2)], ctxt_block6relu1_out[i / 2][30+ (i% 2)]);
        }
    }
    ...
    for (int i = 0; i < 4; ++i) { // 서로 다른 img
        #pragma omp parallel num_threads(10)
        {
            ctxt_block7conv_onebyone_out[i] = Convp(context, pack, eval, 32, 2, 2, 32, 64, ctxt_block6relu1_out[i], block7conv_onebyone_multiplicands64_32_1_1);
        }
    }
    ...
    for (int i = 0; i < 4; ++i) { // 서로 다른 img
        ctxt_block7conv0_out[i] = Conv_parallelp(context, pack, eval, 32, 2, 2, 32, 64, ctxt_block6relu1_out[i], block7conv0multiplicands64_32_3_3);
    }
 ...
 // Second convolution
    ...
    for (int i = 0; i < 1; ++i) {
        ctxt_block7conv1_out[i] = Conv_parallelp(context, pack, eval, 32, 4, 1, 64, 64, ctxt_block7relu0_out[i], block7conv1multiplicands64_64_3_3);
    }
    ...
    for (int i = 0; i < 1; ++i) { // 서로 다른 img
        //cout << "i = " << i << endl;
        ctxt_block8conv0_out[i] = Conv_parallelp(context, pack, eval, 32, 4, 1, 64, 64, ctxt_block7relu1_out[i], block8conv0multiplicands64_64_3_3);
    }
    ...
    for (int i = 0; i < 1; ++i) {
        ctxt_block8conv1_out[i] = Conv_parallelp(context, pack, eval, 32, 4, 1, 64, 64, ctxt_block8relu0_out[i], block8conv1multiplicands64_64_3_3);
    }
    ...
    for (int i = 0; i < 1; ++i) { // 서로 다른 img
        //cout << "i = " << i << endl;
        ctxt_block9conv0_out[i] = Conv_parallelp(context, pack, eval, 32, 4, 1, 64, 64, ctxt_block8relu1_out[i], block9conv0multiplicands64_64_3_3);
    }
    ...
    for (int i = 0; i < 1; ++i) {
        ctxt_block9conv1_out[i] = Conv_parallelp(context, pack, eval, 32, 4, 1, 64, 64, ctxt_block9relu0_out[i], block9conv1multiplicands64_64_3_3);
    }
