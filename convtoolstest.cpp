...
int main() {
...

    {
        ...
        weightToPtxtOld(ptxt,13, w, 1,1,0,0, ecd);
        cout << endl << "output weight vector: " << endl;
        wgt = ecd.decode(ptxt);
        printMessage(wgt);
        cout << endl;
        weightToPtxtOld(ptxt,13, w, 1,2,0,0, ecd);
        cout << endl << "output weight vector: " << endl;
        wgt = ecd.decode(ptxt);
        printMessage(wgt);
        cout << endl;
        weightToPtxtOld(ptxt,13, v, 2,1,1,1, ecd);
        cout << endl << "output weight vector: " << endl;
        wgt = ecd.decode(ptxt);
        printMessage(wgt);
        cout << endl;
        weightToPtxtOld(ptxt,13, y, 4,1,1,1, ecd);
        cout << endl << "output weight vector: " << endl;
        wgt = ecd.decode(ptxt);
        printMessage(wgt);
        cout << endl;
        weightToPtxtOld(ptxt,13, v, 2,2,1,1, ecd);
        cout << endl << "output weight vector: " << endl;
        wgt = ecd.decode(ptxt);
        printMessage(wgt);
        cout << endl;
